...
export const GenerateView = ({
  ...
  const isCreatomate = activeTemplate?.render_engine === "creatomate";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-6 space-y-5">
        ...
        {isCreatomate && activeTemplate?.preview_video_url && (
          <div className="rounded-lg border border-blue-500/30 bg-blue-950/20 p-4">
            <p className="text-xs text-blue-400 mb-2">Template Preview</p>
            <video src={activeTemplate.preview_video_url} className="rounded-lg w-full max-h-48 object-contain" controls muted />
          </div>
        )}
